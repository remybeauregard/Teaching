...
subtitle: "Final Exam SQ 2025 -- Answer Key"
author: "Remy Beauregard, Department of Economics, UC Davis"
lang: en
format:
  html:
    output-file: "ECN 102 SQ 2025 Sample Final AK.html"
    theme: cosmo
    include-in-header:
      text: |
        <meta name="description" content="Sample final exam answer key for ECN 102.">
  pdf:
    output-file: "ECN 102 SQ 2025 Sample Final AK.pdf"
execute:
  echo: false
---
...
**This quantity could represent our statistical significance value, which we compare to our p-value, or the test size, the probability of committing a Type I error.**
...
**Left: error variance increasing in $x$. Right: error variance decreasing in $x$.**
