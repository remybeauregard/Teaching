...
## Regression of Price on MPG {.smaller shrink=20}
...
## Regression Results: Price on MPG {.smaller shrink=20}
...
$\Rightarrow$ There **is** a statistically significant association between mpg and price based on p-value approach (or confidence interval of $\beta_2$).
